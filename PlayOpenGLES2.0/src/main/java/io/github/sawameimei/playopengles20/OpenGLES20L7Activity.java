...
public class OpenGLES20L7Activity extends AppCompatActivity implements SurfaceTexture.OnFrameAvailableListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                CameraPreviewWriteSkinGLProgram glProgram = new CameraPreviewWriteSkinGLProgram(getApplicationContext(), mTextureM, PREV_WIDTH, PREV_HEIGHT);
                mPrevSurfaceTexture = new SurfaceTexture(glProgram.texture()[0]);
                mPrevProgram = glProgram;
                mPrevSurfaceTexture.setOnFrameAvailableListener(OpenGLES20L7Activity.this);
