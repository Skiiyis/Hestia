...
public class WriteSkinGLProgram implements TextureGLProgram {
    ...
    public WriteSkinGLProgram(Context context, float[] textureM, int viewportWidth, int viewportHeight) {
    ...
    @Override
    public void compile() {
        mVertexShaderHandle = ShaderHelper.compileShader(GLES20.GL_VERTEX_SHADER, RawResourceReader.readTextFileFromRawResource(mContext.get(), R.raw.write_skin_vertex_sharder));
        mFragmentShaderHandle = ShaderHelper.compileShader(GLES20.GL_FRAGMENT_SHADER, RawResourceReader.readTextFileFromRawResource(mContext.get(), R.raw.write_skin_fragment_sharder));
    ...
    public void draw() {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mFiltertTextureId[0]);
        GLES20.glUniform1i(muCurveLoc, 0);
        ...
        GLES20.glUniform1f(muTexelWidthOffsetLoc, 1.0F / mViewportWidth);
        GLES20.glUniform1f(muTexelHeightOffsetLoc, 1.0F / muTexelWidthOffsetLoc);
